    ...
    (Scheduler.getSchedulerInstance = function () {
      ...
      (g.init = function (t, e, i) {
        ...
        (g._click = {
          dhx_cal_data: function (t) {
            ...
            if (i && g.config.select) {
              ...
              g._close_not_saved(),
                new Date().valueOf() - (g._new_event || 0) > 500 &&
                  g.unselect();
          },
        ...
        (g.addEventNow = function (t, e, i) {
          ...
          t ||
            (t =
              n.start_date || Math.round(g._currentDate().valueOf() / a) * a);
          var r = new Date(t);
          if (!e) {
      ...
      (g.date = {
        ...
        str_to_date: function (t, e, i) {
          var n = E(t, e),
            ...
            r =
              /^[0-9]{2}\/[0-9]{2}\/[0-9]{4} ?(([0-9]{1,2}:[0-9]{2})(:[0-9]{1,2})?)?$/,
            s =
              /^[0-9]{2}\-[0-9]{2}\-[0-9]{4} ?(([0-9]{1,2}:[0-9]{1,2})(:[0-9]{1,2})?)?$/,
            o =
        ...
        (g.uid = function () {
          return (
            this._seed || (this._seed = new Date().valueOf()), this._seed++
          );
        }),
        (g._events = {}),
        (g.clearAll = function () {
        ...
        (g._parsers.xml = {
          ...
          parse: function (t) {
            ...
            i &&
              (window.dhtmlx && (dhtmlx.security_key = i),
              (g.security_key = i));
            for (
        ...
        (g._move_while_dnd = function (t) {
          if (g._dnd_start_lb) {
            ...
            (e.style.top = g._lb_start[1] + i[1] - g._dnd_start_lb[1] + "px"),
              (e.style.left =
                g._lb_start[0] + i[0] - g._dnd_start_lb[0] + "px");
          }
        }),
        ...
        (g.getLightbox = function () {
          ...
          // console.log(t.getElementsByClassName('dhx_lightbox_day_select')[0].value);
          // console.log(t.getElementsByClassName('dhx_lightbox_day_select')[1].value);

          // console.log(t.getElementsByClassName('dhx_lightbox_year_select')[0].value);
          // console.log(t.getElementsByClassName('dhx_lightbox_year_select')[1].value);

          // console.log(t.getElementsByClassName('dhx_lightbox_month_select')[0].value);
          // console.log(t.getElementsByClassName('dhx_lightbox_month_select')[1].value);
        ...
        window.jQuery &&
          (function (t) {
            ...
            t.fn.dhx_scheduler = function (n) {
              ...
              t.error(
                "Method " + n + " does not exist on jQuery.dhx_scheduler"
              );
            };
          })(jQuery),
        (function () {
