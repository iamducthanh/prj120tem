...
Scheduler.plugin(function (e) {
  (e._temp_matrix_scope = function () {
    function t() {
      for (
        var t = e.get_visible_events(), a = [], n = 0;
        n < this.y_unit.length;
        n++
      )
        a[n] = [];
      var i;
      ...
      for (var n = 0; n < t.length; n++) {
        ...
        for (
          var r = 0;
          this._trace_x[r + 1] && t[n].start_date >= this._trace_x[r + 1];

        )
          r++;
        for (; this._trace_x[r] && t[n].end_date > this._trace_x[r]; )
          a[i][r] || (a[i][r] = []), a[i][r].push(t[n]), r++;
      }
      return a;
    }
    function a(t, a, n) {
      ...
      if (s > 0) {
        ...
        var u = e.date.add(
          e._min_date_timeline,
          e.matrix[e._mode].x_step * _,
          e.matrix[e._mode].x_unit
        );
        d
          ? +o > +u && a && (l = e._cols[_])
          : ((s = o - u),
    ...
    function r(t) {
      ...
      if (t && "cell" != this.render) {
        ...
        for (var r = [], d = t.length, l = 0; d > l; l++) {
          var o = t[l];
          o._inner = !1;
          var s = this.round_position
            ? n.apply(this, [o.start_date, !1])
            : o.start_date;
          for (
            this.round_position ? n.apply(this, [o.end_date, !0]) : o.end_date;
            r.length;
          ...
          if ((r.length && (r[r.length - 1]._inner = !0), !c))
            if (r.length)
              if (r.length <= r[r.length - 1]._sorder) {
                ...
                for (var g = r[0]._sorder, f = 1; f < r.length; f++)
                  r[f]._sorder > g && (g = r[f]._sorder);
                (o._sorder = g + 1), (o._inner = !1);
              }
            else o._sorder = 0;
          r.push(o),
            r.length > (r.max_count || 0)
              ? ((r.max_count = r.length), (o._count = r.length))
              : (o._count = o._count ? o._count : 1);
        }
        for (var b = 0; b < t.length; b++) t[b]._count = r.max_count;
        for (var y = 0; d > y; y++)
          a += e.render_timeline_event.call(this, t[y], !1);
      }
      return a;
    }
    function d(a) {
      ...
      if ((e._load_mode && e._load(), "cell" == this.render)) i = t.call(this);
        ...
        for (
          var d = e.get_visible_events(), l = this.order, o = 0;
          o < d.length;
          o++
        ) {
          var s = d[o],
      ...
      (m =
        (e.date.add(m, this.x_step * g, this.x_unit) -
          m -
          (this._start_correction + this._end_correction) * g) /
        p),
        (this._step = m),
        (this._summ = p);
      ...
      for (var v = 0; v < this.y_unit.length; v++) {
        ...
        e._merge(y, { height: this.dy }),
          this.section_autoheight &&
            (this.y_unit.length * y.height < a.offsetHeight &&
              (y.height = Math.max(
                y.height,
                Math.floor((a.offsetHeight - 1) / this.y_unit.length)
              )),
            (this._section_height[this.y_unit[v].key] = y.height)),
          y.td_className ||
            (y.td_className =
              "dhx_matrix_scell" +
              (e.templates[this.name + "_scaley_class"](
                this.y_unit[v].key,
                this.y_unit[v].label,
                this.y_unit[v]
              )
                ...
                : "")),
          y.td_content ||
            (y.td_content = e.templates[this.name + "_scale_label"](
              this.y_unit[v].key,
              this.y_unit[v].label,
              this.y_unit[v]
            )),
        ...
        if (
          ...
          for (var o = 0; o < e._cols.length; o++)
            n += e._ignores[o]
              ? "<td></td>"
              : "<td class='dhx_matrix_cell " +
                e.templates[this.name + "_cell_class"](
                  i[v][o],
                  this._trace_x[o],
                  this.y_unit[v]
                ) +
                ...
                (e._cols[o] - 1) +
                "px'>" +
                e.templates[this.name + "_cell_value"](
                  i[v][o],
                  this._trace_x[o],
                  this.y_unit[v]
                ) +
      ...
      (n += "</table>"),
        ...
        (a.innerHTML = n),
        (e._rendered = []);
      for (var w = e._obj.getElementsByTagName("DIV"), v = 0; v < w.length; v++)
        w[v].getAttribute("event_id") && e._rendered.push(w[v]);
      this._scales = {};
      for (
        var D = a.firstChild.rows, E = null, v = 0, M = b.length;
        M > v;
        v++
      ) {
        (E = this.y_unit[v]), f.push(b[v].height);
        var S = E.key,
          N = (this._scales[S] = e._isRender("cell")
            ? D[v]
            : D[v].childNodes[1].getElementsByTagName("div")[0]);
    ...
    function l(t) {
      ...
      for (
        var i = (this.x_size + (t ? e._ignores_detected : 0), 0), r = 0;
        +n > +a;
    ...
    function o(t) {
      ...
      for (
        var o = (e._min_date_timeline = e._min_date),
        ...
        e._ignores[p]
          ? ((e._cols[p] = 0), u++)
          : (e._cols[p] = Math.floor(i / (u - p))),
          (i -= e._cols[p]),
          (r[p + 1] = r[p] + e._cols[p]);
      if (((t.innerHTML = "<div></div>"), this.second_scale)) {
        for (
          var m = this.second_scale.x_unit,
            g = [this._trace_x[0]],
            f = [],
            b = [this.dx, this.dx],
            y = 0,
            x = 0;
          x < this._trace_x.length;
          x++
        ) {
        ...
        for (var S = 0; S < g.length; S++) {
          ...
          (T.className =
            "dhx_scale_bar dhx_second_scale_bar" + (O ? " " + O : "")),
    ...
    function c(t) {
      if ((_.call(this, t), t)) {
        ...
        o.call(this, e._els.dhx_cal_header[0]),
          ...
          (e._min_date = a),
          (e._els.dhx_cal_date[0].innerHTML = e.templates[this.name + "_date"](
            e._min_date,
            e._max_date
          )),
    ...
    function h(t, a, n) {
      if ("cell" == t.render) {
        ...
        for (var l = "", o = 0; o < r.length; o++) {
          ...
          (l +=
            ...
            (l +=
              ...
              (r[o]._timed ? e.templates.event_date(r[o].start_date) : "") +
              "</div>"),
        ...
        (e._tooltip.style.display = ""),
          ...
          document.body.offsetWidth - n.left - e._tooltip.offsetWidth < 0
    ...
    function v(e) {
      ...
      if (t && "DIV" == t.tagName) {
        ...
        if ("dhx_scale_bar" == a) return { x: p(t), y: -1, src: t, scale: !0 };
      }
    }
    (e.matrix = {}),
      ...
      (e.createTimelineView = function (t) {
        e._skin_init(),
          ...
          (t._start_correction = t.first_hour
            ? 60 * t.first_hour * 60 * 1e3
            : 0),
          (t._end_correction = t.last_hour
            ? 60 * (24 - t.last_hour) * 60 * 1e3
            : 0),
          e.checkEvent("onTimelineCreated") &&
            e.callEvent("onTimelineCreated", [t]);
        var a = e.render_data;
        (e.render_data = function (n, i) {
          if (this._mode != t.name) return a.apply(this, arguments);
          if (i && !t.show_unassigned && "cell" != t.render)
            for (var r = 0; r < n.length; r++)
              this.clear_event(n[r]),
          ...
          (e.templates[t.name + "_date"] = function (t, a) {
            return (t.getDay() == a.getDay() && 864e5 > a - t) ||
              +t == +e.date.date_part(new Date(a)) ||
              (+e.date.add(t, 1, "day") == +a &&
                0 === a.getHours() &&
                0 === a.getMinutes())
              ? e.templates.day_date(t)
              : t.getDay() != a.getDay() && 864e5 > a - t
              ? e.templates.day_date(t) + " &ndash; " + e.templates.day_date(a)
              : e.templates.week_date(t, a);
          }),
          (e.templates[t.name + "_scale_date"] = e.date.date_to_str(
            t.x_date || e.config.hour_date
          )),
          (e.templates[t.name + "_second_scale_date"] = e.date.date_to_str(
            t.second_scale && t.second_scale.x_date
              ? t.second_scale.x_date
              : e.config.hour_date
          )),
          ...
          (e.date["add_" + t.name] = function (a, n, i) {
            var r = e.date["add_" + t.name + "_private"](
              a,
              (t.x_length || t.x_size) * t.x_step * n
            );
            if ("minute" == t.x_unit || "hour" == t.x_unit) {
              ...
              if ((l * d) % 1440)
                if (
                  ...
                  var o = 1440 / (d * l) - 1,
                    s = Math.round(o * d);
                  n > 0
                    ? (t.x_start = t.x_start - s)
                    : (t.x_start = s + t.x_start);
                }
            }
            return r;
          }),
          ...
          if (
            ...
            if (
              ...
              void 0 === d._move_delta &&
                ((d._move_delta = (i.start_date - r) / 6e4),
              ...
              var l =
                (d._event_length,
                this._get_fictional_event_length(r, d._move_delta, t, !0));
              r = new Date(r - l);
          ...
          if (
            ("resize" == this._drag_mode &&
              ...
              (!this.config.timeline_swap_resize &&
                this._drag_id &&
                (this._drag_from_start && +r > +i.end_date
                  ? (this._drag_from_start = !1)
                  : !this._drag_from_start &&
                    +r < +i.start_date &&
                    (this._drag_from_start = !0)),
              (a.resize_from_start = this._drag_from_start),
              !this.config.timeline_swap_resize &&
                this._drag_id &&
                this._drag_from_start &&
            ...
            switch (this._drag_mode) {
              case "move":
                this.config.preserve_length ||
                  ((r = n.call(t, r, !1)),
                  "day" == t.x_unit && (a.custom = !1));
                break;
              case "resize":
                this._drag_event &&
                  ((null === this._drag_event._resize_from_start ||
                    void 0 === this._drag_event._resize_from_start) &&
                    (this._drag_event._resize_from_start = a.resize_from_start),
                  (a.resize_from_start = this._drag_event._resize_from_start),
                  (r = n.call(t, r, !this._drag_event._resize_from_start)));
            }
      ...
      (e._get_timeline_event_height = function (e, t) {
        ...
        return (
          ...
          t.resize_events &&
            (n = Math.max(Math.floor(n / e._count), t.event_min_dy)),
          n
        );
      }),
      ...
      (e.render_timeline_event = function (t, n) {
        ...
        var _ = e._get_timeline_event_y(t._sorder, o),
          c = o + _ + 2;
        (!this._events_height[i] || this._events_height[i] < c) &&
          (this._events_height[i] = c);
      ...
      (e._locate_cell_timeline = function (t) {
        ...
        for (
          var a = t.target ? t.target : t.srcElement,
            ...
            l = 0,
            o = 0;
          o < i._trace_x.length - 1 && !(+r.date < i._trace_x[o + 1]);
          o++
        )
          d[o] || l++;
        ...
        n.src = i._scales[r.section]
          ? i._scales[r.section].getElementsByTagName("td")[o + s]
          : null;
        for (
          var _ = !1;
          0 === n.x && "dhx_cal_data" != a.className && a.parentNode;
    ...
    (e._click.dhx_marked_timespan = e._click.dhx_cal_data =
      function (t) {
      ...
      e.attachEvent("onCellDblClick", function (t, a, n, i, r) {
        if (
          ...
          (l.start_date = d._trace_x[t]),
            (l.end_date = d._trace_x[t + 1]
              ? d._trace_x[t + 1]
              : e.date.add(d._trace_x[t], d.x_step, d.x_unit)),
            d._start_correction &&
              (l.start_date = new Date(1 * l.start_date + d._start_correction)),
            d._end_correction &&
              (l.end_date = new Date(l.end_date - d._end_correction)),
      ...
      if (e.matrix && e.matrix[e._mode]) {
        ...
        if (i) (_ = [n]), (s = [i]);
          ...
          if (c) u.hasOwnProperty(c) && (s.push(c), _.push(l._scales[c]));
            ...
            for (var h in u)
              u.hasOwnProperty(h) && (s.push(h), _.push(l._scales[h]));
        }
        ...
        for (
          var p = 0;
          p < l._trace_x.length && !e._is_column_visible(l._trace_x[p]);
          p++
        );
        ...
        for (
          var g = t.zones, b = e._get_css_classes_by_config(t), y = 0;
          y < s.length;
          y++
        ) {
          (n = _[y]), (i = s[y]);
          for (var p = 0; p < v.length; p++)
            for (var x = v[p], k = 0; k < g.length; k += 2) {
              ...
              if (M > r && d > E) {
                ...
                S.className = b;
                var N = a({ start_date: E }, !1, l) - 1,
                  O = a({ start_date: M }, !1, l) - 1,
                  T = Math.max(1, O - N - 1),
    ...
    (e._on_scale_add_marker = function (t, a) {
        ...
        if (i && e.matrix && e.matrix[e._mode])
          for (
            ...
            var _ = +s,
              ...
              h = o[_] || o[c];
            if (
              (u.push.apply(u, e._get_configs_to_render(h)), i[r] && i[r][a])
            ) {
              var p = [],
      ...
      (e._get_date_index = function (e, t) {
        for (var a = 0, n = e._trace_x; a < n.length - 1 && +t >= +n[a + 1]; )
          a++;
        return a;
      }),
      (e._timeline_drag_date = function (t, a) {
        ...
        if (r.round_position) {
          var s = 1;
          e.getState().drag_mode &&
            "move" != e.getState().drag_mode &&
            (s = 0.5),
            n >= s && o++,
            (n = 0);
        }
        ...
        var _;
        if (o >= r._trace_x.length)
          (_ = e.date.add(
            r._trace_x[r._trace_x.length - 1],
            r.x_step,
            r.x_unit
          )),
      ...
      e.attachEvent("onBeforeDrag", function (t, a, n) {
        if ("resize" == a) {
          ...
          (i.className || "").indexOf("dhx_event_resize_end") < 0
